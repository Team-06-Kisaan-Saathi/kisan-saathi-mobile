                ...
                { text: "Cancel", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert(
                                "Error",
                                err.response?.data?.message || "Could not accept deal."
                            );
                        }
                    },
                },
            ...
            { text: "Cancel", style: "cancel" },
            {
                ...
                onPress: async () => {
                    try {
                        ...
                        if (res.success) {
                            setDealData(res.deal);
                            Alert.alert("Deal Rejected");
                        }
                    } catch (err: any) {
                        Alert.alert(
                            "Error",
                            err.response?.data?.message || "Could not reject deal."
                        );
                    }
                },
            },
    ...
    const handleCounterOffer = async () => {
        ...
        try {
            ...
            if (res.success) {
                ...
                setCounterPrice("");
                Alert.alert("✅ Counter-offer Sent", `New offer: ₹${price}`);
            }
        } catch (err: any) {
            Alert.alert(
                "Error",
                err.response?.data?.message || "Could not send counter-offer."
            );
        }
    };
